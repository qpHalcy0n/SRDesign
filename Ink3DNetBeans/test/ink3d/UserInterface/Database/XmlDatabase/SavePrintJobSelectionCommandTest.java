...
public class SavePrintJobSelectionCommandTest {
    ...
    public void setUp() {       
        ...
        subset1.setTopZ(1);
        subset1.getFileConfigurations().add(new FileSelection("03-extruder1", "material1", "file1"));
        subset1.getFileConfigurations().add(new FileSelection("01-extruder2", "material2", "file2"));
        subset1.getFileConfigurations().add(new FileSelection("02-extruder3", "material3", "file3"));
        
        SubsetSelection subset2 = new SubsetSelection();
        subset2.setBottomZ(1);
        subset2.setPrintConfiguration("SaveTest.Sub2.Print");
        subset2.setTopZ(2);
        subset2.getFileConfigurations().add(new FileSelection("01-extruder2", "material2", "file1"));
        subset2.getFileConfigurations().add(new FileSelection("02-extruder3", "material3", "file2"));
        subset2.getFileConfigurations().add(new FileSelection("03-extruder1", "material1", "file3"));
        
        printJob = new PrintJobSelection();
        printJob.setName("SaveTest");
        printJob.setPrinterConfiguration("SaveTest.printer");
        printJob.getMaterials().add(new ExtruderMaterialSelection("03-extruder 1", "material 1"));
        printJob.getMaterials().add(new ExtruderMaterialSelection("01-extruder 2", "material 1"));
        printJob.getMaterials().add(new ExtruderMaterialSelection("02-extruder 3", "material 2"));
        ...
        expected ="<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
                    ...
                    "    <extruderMarterial>\n" +
                    "        <extruder>03-extruder 1</extruder>\n" +
                    "        <material>material 1</material>\n" +
                    "    </extruderMarterial>\n" +
                    "    <extruderMarterial>\n" +
                    "        <extruder>01-extruder 2</extruder>\n" +
                    "        <material>material 1</material>\n" +
                    "    </extruderMarterial>\n" +
                    "    <extruderMarterial>\n" +
                    "        <extruder>02-extruder 3</extruder>\n" +
                    ...
                    "            <extruder>03-extruder1</extruder>\n" +
                    "            <material>material1</material>\n" +
                    "        </fileSelection>\n" +
                    "        <fileSelection>\n" +
                    "            <file>file2</file>\n" +
                    "            <extruderNum>0</extruderNum>\n" +
                    "            <extruder>01-extruder2</extruder>\n" +
                    "            <material>material2</material>\n" +
                    "        </fileSelection>\n" +
                    "        <fileSelection>\n" +
                    "            <file>file3</file>\n" +
                    "            <extruderNum>0</extruderNum>\n" +
                    "            <extruder>02-extruder3</extruder>\n" +
